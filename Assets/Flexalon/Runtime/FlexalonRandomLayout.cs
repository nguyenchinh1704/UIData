...
namespace Flexalon
{
    [ExecuteAlways, HelpURL("https://www.flexalon.com/docs/randomLayout")]
    public class FlexalonRandomLayout : LayoutBase
    {
        ...
        [SerializeField, Range(0, 360)]
        private float _rotationMaxX = 360;
        ...
        [SerializeField, Range(0, 360)]
        private float _rotationMaxY = 360;
        ...
        [SerializeField, Range(0, 360)]
        private float _rotationMaxZ = 360;
